...
<div class="min-h-[70vh] flex items-center justify-center px-4">
    <div class="max-w-md w-full bg-white shadow-xl rounded-2xl p-10 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-3">Access Denied</h1>
        ...
        <a href="/" class="inline-flex items-center gap-2 bg-[#C25A2A] hover:bg-[#a94d23] text-white px-6 py-3 rounded-xl font-semibold transition">
            <i data-lucide="home"></i> Go to Home
        </a>
    </div>
</div>
        ...
        <div class="{{ $isCancelled ? 'bg-gradient-to-r from-red-700 to-red-800' : 'bg-gradient-to-r from-[#C25A2A] to-[#E06B36]' }} text-white p-6 sm:p-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="text-xs sm:text-sm text-orange-100 font-medium">Official Customer Receipt & Invoice</p>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start gap-6 border-t border-gray-200 pt-6">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <div class="text-xs text-gray-500 space-y-1">
                        <p>• Thank you for ordering with {{ $order->restaurant->name ?? 'HYST' }}.</p>
                        <p>• This invoice serves as proof of payment and tax record.</p>
                    </div>
                </div>
