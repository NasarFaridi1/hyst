...
<div class="max-w-3xl mx-auto">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Updating <strong style="color:#C25A2A;">{{ $category->name }}</strong></p>
        </div>
    ...
    <div class="hyst-card">
        ...
        <div class="card-head">
            ...
            <div>
                <p class="card-head-title">Edit Category Details</p>
                <p class="card-head-sub">Changes will apply immediately after saving</p>
            </div>
        </div>

        <form method="POST" enctype="multipart/form-data" action="{{ route('ambassador.categories.update',[$restaurant->id,$category->id]) }}">
            @csrf
            @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <div class="field-wrap">
                            ...
                            <input type="text" name="name" value="{{ old('name',$category->name) }}" placeholder="Category name" class="field-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field-wrap">
                            ...
                            <input type="number" name="display_order" value="{{ old('display_order',$category->display_order) }}" placeholder="0" class="field-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group full">
                        ...
                        @if($category->image)
                            <div class="current-img-wrap">
                                <img src="{{ asset('storage/'.$category->image) }}" class="current-img" id="img-preview-edit">
...
function previewEdit(input) {
    ...
    if (!preview) {
        ...
        wrap.className = 'current-img-wrap';
        var label = document.createElement('div');
        label.className = 'current-img-label';
        label.innerHTML = 'New image <span>Will replace current on save</span>';
        wrap.appendChild(preview);
        wrap.appendChild(label);
        input.closest('.form-group').insertBefore(wrap, input.closest('.file-zone'));
    }
