                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <div style="display:flex; flex-wrap:wrap; gap:16px; padding:14px 16px; border:1.5px solid #EBE5DE; border-radius:12px; background:#FDFAF7;">
                            <label style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:14px; font-weight:600; color:#0D0D0D;">
                                <input type="checkbox" name="dietary_categories[]" value="halal" {{ in_array('halal', $savedDietary) ? 'checked' : '' }} style="width:16px; height:16px; accent-color:#C25A2A;">
                                <span>🌙 Halal</span>
                            </label>
                            <label style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:14px; font-weight:600; color:#0D0D0D;">
                                <input type="checkbox" name="dietary_categories[]" value="vegan" {{ in_array('vegan', $savedDietary) ? 'checked' : '' }} style="width:16px; height:16px; accent-color:#C25A2A;">
                                <span>🌱 Vegan</span>
                            </label>
                            <label style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:14px; font-weight:600; color:#0D0D0D;">
                                <input type="checkbox" name="dietary_categories[]" value="vegetarian" {{ (in_array('vegetarian', $savedDietary) || in_array('vegetable', $savedDietary)) ? 'checked' : '' }} style="width:16px; height:16px; accent-color:#C25A2A;">
                    ...
                    <div class="form-group full">
                        ...
                        @if($restaurant->hygiene_certificate)
                            <a href="{{ file_exists(public_path($restaurant->hygiene_certificate)) ? asset($restaurant->hygiene_certificate) : asset('storage/'.$restaurant->hygiene_certificate) }}" target="_blank" class="current-link">
